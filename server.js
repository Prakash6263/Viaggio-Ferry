...
const internalPaymentReceiptRoutes = require("./src/routes/internalPaymentReceiptRoutes")
const generalLedgerRoutes = require("./src/routes/generalLedgerRoutes")
const trialBalanceRoutes = require("./src/routes/trialBalanceRoutes")
const fiscalYearRoutes = require("./src/routes/fiscalYearRoutes")
const passengerBookingRoutes = require("./src/routes/passengerBookingRoutes")
const vehicleBookingRoutes = require("./src/routes/vehicleBookingRoutes")
const cargoBookingRoutes = require("./src/routes/cargoBookingRoutes")
const passengerBoardingRoutes = require("./src/routes/passengerBoardingRoutes")
const cargoBoardingRoutes = require("./src/routes/cargoBoardingRoutes")
const vehicleBoardingRoutes = require("./src/routes/vehicleBoardingRoutes")
const tripReportRoutes = require("./src/routes/tripReportRoutes")
...
app.use("/api/internal-payments", internalPaymentReceiptRoutes)
app.use("/api/general-ledger", generalLedgerRoutes)
app.use("/api/trial-balance", trialBalanceRoutes)
app.use("/api/accounting", fiscalYearRoutes)
app.use("/api/bookings/passenger", passengerBookingRoutes)
app.use("/api/bookings/vehicle", vehicleBookingRoutes)
app.use("/api/bookings/cargo", cargoBookingRoutes)
app.use("/api/boardings/passenger", passengerBoardingRoutes)
app.use("/api/boardings/cargo", cargoBoardingRoutes)
app.use("/api/boardings/vehicle", vehicleBoardingRoutes)
